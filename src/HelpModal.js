...
const HelpModal = ({ setLoadHelp }) => {
    ...
    const text2 = <p>You can follow the same process for the other images.<br />
    ...
    const text3 = <p>An alrtered image of Vermeer's "Astronomer" appears in the image repository<br />
    ...
    const text4 = <p>At this point a new Hash must be found.
    </p>
    
    const text5 = <p>If the altered block is rehashed, Prev Hash of the next block will no longer match the Hash of altered block.</p>

    const text6 = <p>The process is intentionally cumbersome. <br />
    ...
    const text7 = <p>Paste the new Hash of the previous block from the clipboard,<br />
